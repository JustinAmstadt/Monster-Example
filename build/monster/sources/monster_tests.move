...
module monster::monster_tests {
    ...
    fun test_monster() {
        ...
        {
            monster::mint_to_address(user1, string::utf8(name), string::utf8(desc), string::utf8(cry), test_scenario::ctx(scenario));
        };
        ...
        {
            monster::mint_to_address(user2, string::utf8(name1), string::utf8(desc1), string::utf8(cry), test_scenario::ctx(scenario));
        };
